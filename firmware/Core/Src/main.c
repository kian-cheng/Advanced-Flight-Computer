...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(RGB_DIN_GPIO_Port, RGB_DIN_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : RF_DIO0_Pin RF_DIO1_Pin BMP_INT_Pin */
  GPIO_InitStruct.Pin = RF_DIO0_Pin|RF_DIO1_Pin|BMP_INT_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_IT_RISING;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(GPIOB, &GPIO_InitStruct);

  /*Configure GPIO pin : RGB_DIN_Pin */
  GPIO_InitStruct.Pin = RGB_DIN_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(RGB_DIN_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pins : PD8 ARM_DET_Pin SD_CD_Pin */
  GPIO_InitStruct.Pin = GPIO_PIN_8|ARM_DET_Pin|SD_CD_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
